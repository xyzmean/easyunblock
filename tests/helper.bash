...
COMMON_SH="$REPO_ROOT/easyunblock/files/usr/local/lib/easyunblock/common.sh"
DOCTOR_SH="$REPO_ROOT/easyunblock/files/usr/local/sbin/easyunblock-doctor"
FAILOVER_SH="$REPO_ROOT/easyunblock/files/usr/local/sbin/easyunblock-failover"
