#!/usr/bin/env bats
# Unit tests for easyunblock's pure logic (no router, no uci/nft/ip).
# Run: bats tests/   — or off-box, the doctor selftest: EASYUNBLOCK_SELFTEST=1 easyunblock-doctor
